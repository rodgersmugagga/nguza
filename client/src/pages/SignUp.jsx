...
import { FaUser, FaPhoneAlt, FaEnvelope, FaLock, FaArrowLeft, FaCheckCircle, FaExclamationCircle } from "react-icons/fa";
...
export default function SignUp() {
  ...
  return (
    <>
      <Helmet>
        <title>Create Account | Nguza - Uganda's Agriculture Marketplace</title>
        <meta name="description" content="Join Nguza today. Create a free account to post listings and grow your agricultural business in Uganda." />
      </Helmet>
      ...
      <main className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#fafbfc] py-12 px-4 md:py-20">
        ...
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-color-primary/5 rounded-full blur-3xl" />
